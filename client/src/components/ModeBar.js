      ...
      return(
        <div className={"modebar" + (this.props.mode === AppMode.LOGIN ? 
          ...
          <a className={"modebar-btn" +
            ...
            <span className="modebar-text">Portfolio</span>
          </a>
          ...
          <a className={"modebar-btn" + 
            ...
            <span className="modebar-text">Music</span>
          </a>

		  <a className={"modebar-btn" + 
            (this.props.mode === AppMode.EXPLORE ? " modebar-item-selected" : "")} 
            onClick={this.props.menuOpen ? null : 
              () => this.handleModeBtnClick(AppMode.EXPLORE)}>
            <span className="modebar-icon nonMenuItem fa fa-th-list"></span>
