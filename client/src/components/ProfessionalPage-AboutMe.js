		...
		return (
			<div>
				...
				<div id='body'>
					...
					<p>My name is Nolen.</p>
					<p>I made this website from scratch, by myself, for myself</p>
					<p>
					...
					<h3>About Me</h3>
					<p>
						My name is Nolen Young. I am currently a senior in Computer Science
						at Washington State University. I will be graduating and earning my
						bachelors degree this May. I grew up in Olympia, Washington, and
						graduated from Olympia High School in 2016.
					</p>
					<p className='links'>
						<a
